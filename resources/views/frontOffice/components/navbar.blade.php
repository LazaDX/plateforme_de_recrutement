        ...
        <div class="flex items-center justify-between h-16">
            ...
            <nav class="hidden lg:flex flex-1 justify-center">
                <div class="flex space-x-8">
                    @foreach ([['name' => "Offre d'enquête", 'href' => '/enquirer/offers'], ['name' => 'Mes candidatures', 'href' => '/enquirer/applications'], ['name' => 'Tableau de bord', 'href' => '/enquirer/history']] as $item)
                        <a href="{{ $item['href'] }}"
            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                ...
                <div x-show="open" x-transition
                    ...
                    <a href="/enquirer/profile"
                        class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                        <x-icon-user class="h-4 w-4 mr-2" />
                        Mon profil
                    </a>
                    <form method="POST" action="{{ route('enqueteur.logout') }}">
                        ...
                        <button type="submit"
                            ...
                            <x-icon-logout class="h-4 w-4 mr-2" />
                            Se déconnecter
                        </button>
                    </form>
                </div>
